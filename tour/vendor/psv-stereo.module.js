/*!
 * Photo Sphere Viewer / Stereo Plugin 5.14.3
...
var _StereoPlugin = class _StereoPlugin extends AbstractPlugin {
  constructor(viewer) {
    super(viewer);
    this.state = {
      enabled: false,
...
_StereoPlugin.id = "stereo";
_StereoPlugin.VERSION = "5.14.3";
var StereoPlugin = _StereoPlugin;
